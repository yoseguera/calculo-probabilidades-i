...
\]
mide la asimetría de la distribución alrededor de su media. También se usa el \emph{coeficiente de asimetría de la distribución}\footnote{Si la distribución es simétrica vale 0.}.
\[
...
La varianza residual de la suma de varias variables aleatorias es
\[
\sigma^2(X_1 + X_2) = \sigma^2(X_1) + \sigma^2(X_2) + 2\Cov(X_1,X_2)
\]
...
Si $X_1$ y $X_2$ son dos variables aleatorias independientes, con funciones generatrices $G_1(z)$ y $G_2(z)$, la función generatriz de la suma $X_1 + X_2$ es el producto $G_1(z)G_2(z)$.

\begin{align*}
    E[X] &= G'(1) \\
    E[X^2] &= G''(1) + G'(1) \\
    \sigma^2(X) &= G''(1) + G'(1) - G'(1)^2 \\
    E[X^3] &= G'''(1) + 3G''(1) + G'(1) \\
    X^2& = \sum x_iI_i - \sum x_ix_jI_iI_j
\end{align*}
