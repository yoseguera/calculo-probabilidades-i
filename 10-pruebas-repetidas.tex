...
\begin{theorem}[Teorema de Poisson]
    Si $n$ tiende a infinito y $p$ tienda a cero, de tal manera que el producto $np$ converge a una constante $\lambda=np$, se verifica
    \[
...
\begin{theorem}[Teorema de Moivre-Laplace]
    Cuando $n$ tiende a infinito, si $k$\footnote{Debe estar en el entorno de $np$.} tiende hacia infinito de manera que
    \[
